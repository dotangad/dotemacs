...
#+begin_src emacs-lisp
  ...
  (set-face-attribute 'org-special-keyword nil :inherit 'fixed-pitch :height 90 :foreground "#aaaaaa")
  (set-face-attribute 'org-property-value nil :inherit 'fixed-pitch :height 90 :foreground "#aaaaaa")
  (set-face-attribute 'org-drawer nil :inherit 'fixed-pitch :height 90 :foreground "#aaaaaa")
  (set-face-attribute 'org-date nil :inherit 'fixed-pitch :height 90 :foreground "#aaaaaa")
...
#+begin_src emacs-lisp
  ...
  (setq org-capture-templates
    '(("l"                          ; hotkey
      ...
      ("m" "Ear Medication" entry (file "~/notes/ear-meds.org")
...
Function which searches for current weekly file, and today's heading. I'll have to look into the =function= org-capture target.
